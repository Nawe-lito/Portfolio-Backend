...
public class CProyectos {
    ...
    public ResponseEntity<?> create(@RequestBody dtoProyectos dtoproyectos){
        ...
        Proyectos proyectos = new Proyectos(
                dtoproyectos.getNombrePro(), dtoproyectos.getDescripcionPro(), dtoproyectos.getImagenPro(), dtoproyectos.getAnioPro(), dtoproyectos.getUrlPro());
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody dtoProyectos dtoproyectos){
        ...
        proyectos.setAnioPro(dtoproyectos.getAnioPro());
        proyectos.setUrlPro(dtoproyectos.getUrlPro());
